...
class SettingsWindow(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        layout.addLayout(self._labeled_row("Stimuli duration (s):", self.stimuli_input))
    ...
    def save_to_file(self):
        ...
        lines = [
            ...
            f"corner_location={self.get_selected_corner()}",
            f"corner_scale={self.scale_slider.value() / 100}",
